-- Sacred Circle Supabase Setup - RUN THIS FILE ALONE in SQL Editor.
-- Do not wrap this in BEGIN/COMMIT. Run files 01, then 02, then 03.

-- =========================================================
-- 3. Production-safe baseline settings
-- =========================================================
